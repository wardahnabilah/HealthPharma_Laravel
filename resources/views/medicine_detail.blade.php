    ...
    <main>
        <div class="p-5 w-50 mx-auto rounded-4 shadow">
            ...
            <div class="w-75 mx-auto text-center mt-5">
                <form action="/medicine/{{$id_obat}}" method="POST" class="d-inline-block">
                @method('DELETE')
                @csrf
                ...
                <a href="/medicine/{{$id_obat}}/edit" class="d-inline-flex align-items-center gap-2 btn btn-primary btn-primary-info mx-2">
