        ...
        <table class="table table-bordered border-dark text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{-- Delete button --}}
                        <form action="/medicines/{{$medicine->id}}" method="POST" class="d-inline-block">
                        @method('DELETE')
                        @csrf
                        ...
                        {{-- Edit button --}}
                        <a href="/medicines/{{$medicine->id}}/edit" class="btn btn-outline-primary btn-primary-sm">
                        ...
                        {{-- Lihat Detail button --}}
                        <a href="/medicines/{{$medicine->id}}" class="btn btn-warning btn-primary-sm">Lihat Detail</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
